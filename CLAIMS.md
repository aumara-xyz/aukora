...
Test totals: 169 (root) + 21 (kernel) + 17 (memory) + 51 (mind) + 171 (brain; +2 gated smokes) + 338 (seed) + 44 (console) + 57 (spatial) + 1 (fixture-regeneration guard) = **869 passing**, none borrowed from any external product suite. (Counts gated by `test:all`; the continuity guard `scripts/verify-continuity.mjs` keeps this total honest.)
